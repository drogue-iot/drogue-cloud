...
#[derive(Clone, Debug)]
pub struct CommandRoutingClient {
...
pub struct CommandRoutingClientConfig {
    #[serde(default = "defaults::command_routing_url")]
    pub url: Url,
...
impl Default for CommandRoutingClientConfig {
    fn default() -> Self {
        Self {
            url: defaults::command_routing_url(),
...
impl CommandRoutingClient {
    ...
    pub async fn from_config(config: CommandRoutingClientConfig) -> anyhow::Result<Self> {
