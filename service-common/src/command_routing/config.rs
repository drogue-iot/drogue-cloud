use crate::client::CommandRoutingClientConfig;
use serde::Deserialize;
use std::time::Duration;

#[derive(Clone, Debug, Deserialize)]
pub struct CommandRoutingControllerConfiguration {
    #[serde(default)]
    pub client: CommandRoutingClientConfig,
    pub endpoint: String,
...
impl Default for CommandRoutingControllerConfiguration {
    fn default() -> Self {
        Self {
