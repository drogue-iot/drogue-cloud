...
For Kafka this needs https://strimzi.io/[Strimzi]. I deployed "AMQ Streams" from OperatorHub.

=== Grafana Operator

For having nice dashboards. I installed "Grafana Operator 3.5.0" from OperatorHub.
