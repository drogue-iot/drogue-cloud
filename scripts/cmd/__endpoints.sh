...
COAP_ENDPOINT_HOST="$(get_env deploy/console-backend endpoint ENDPOINTS__COAP_ENDPOINT_HOST)"
COAP_ENDPOINT_PORT="$(get_env deploy/console-backend endpoint ENDPOINTS__COAP_ENDPOINT_PORT)"
